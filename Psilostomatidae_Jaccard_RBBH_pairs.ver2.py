...
def specificity_comparison(pair_dict, first_stage_tag, second_stage_tag, Jaccard_dict, Intersection_dict):
...
def output_files_creating(Intersection_dict, Jaccard_dict, pair_dict, first_tag, second_tag, output):
...
if __name__ == "__main__":
    sp1_gene_map_dict, sp2_gene_map_dict, pairs_dict, Jaccard_dict, Intersection_dict = {}, {}, {}, {}, {}
    ...
    specificity_comparison(pairs_dict, "R", "R", Jaccard_dict, Intersection_dict)
    specificity_comparison(pairs_dict, "R", "C", Jaccard_dict, Intersection_dict)
    specificity_comparison(pairs_dict, "R", "M", Jaccard_dict, Intersection_dict)
    specificity_comparison(pairs_dict, "C", "R", Jaccard_dict, Intersection_dict)
    specificity_comparison(pairs_dict, "C", "C", Jaccard_dict, Intersection_dict)
    specificity_comparison(pairs_dict, "C", "M", Jaccard_dict, Intersection_dict)
    specificity_comparison(pairs_dict, "M", "R", Jaccard_dict, Intersection_dict)
    specificity_comparison(pairs_dict, "M", "C", Jaccard_dict, Intersection_dict)
    specificity_comparison(pairs_dict, "M", "M", Jaccard_dict, Intersection_dict)
    output_files_creating(Intersection_dict, Jaccard_dict, pairs_dict, args.first_tag, args.second_tag, args.output)
